...
const uploadedInfoMessages = new Set([
  ...
  "rtc.remote_stream_received",
  "rtc.remote_track_received",
  "rtc.stage_diagnostics",
  "rtc.stream_track_unmuted",
  "rtc.stream_video_attached",
  "rtc.stream_video_event",
  "rtc.stream_video_play_succeeded",
  "signal.connected",
